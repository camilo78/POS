                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ingrediente" class="form-control" value="<?php echo e($lims_product_data->ingrediente); ?>" id="ingrediente" aria-describedby="ingrediente" required>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/salepro/resources/views/product/edit.blade.php ENDPATH**/ ?>