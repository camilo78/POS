      ...
      <div class="modal-content">
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center details">
                   <?php echo e(trans('file.Purchase Details')); ?>
            ...
            <table class="table table-bordered product-purchase-list">
                <thead>
                    <th>#</th>
                    <th width="30%"><?php echo e(trans('file.product')); ?></th>
                    <th width="10%"><?php echo e(trans('file.Batch No')); ?></th>
                    <th width="10%">Qty</th>
                    <th width="10%"><?php echo e(trans('file.Unit Cost')); ?></th>
                    <th width="10%"><?php echo e(trans('file.Tax')); ?></th>
                    <th width="10%"><?php echo e(trans('file.Discount')); ?></th>
...
<script type="text/javascript">
    ...
    function imprSelec(seleccion) {
      ...
      ventimp.document.write('<html><head><title>' + document.title + '</title> </title> <style media="print"> .col-md-12{margin-bottom:0px} @page  {size: auto;/* es el valor por defecto */ margin-top:0cm; margin-bottom 1px}.col-md-6 {width:48%; margin-right:5px; margin-bottom:25px;float:left;}body{font-size:14px;margin:0px;transform: scale(.9);} table {cell-spacing: 0;border-collapse: collapse; margin-top 50px !important;page-break-after:auto} tr    { page-break-inside:avoid; page-break-after:auto }td{ page-break-inside:avoid; page-break-after:auto }thead{ display:table-header-group }tfoot { display:table-footer-group }thead > tr {background-color: #025B86;color: white;}thead > tr > * {font-size: 13px;padding: 0.45em;} tr > * {padding: 0.125em 0.45em;} th, td{border: solid 1px #025B86;} .text-right{text-align: right } .text-center{text-align: center; } .d-print-none{display:none} h5{font-size:18px;margin-top: 0;margin-bottom:10px;text-align:center;} h1, h3{text-align:center}</style>');
    ...
    function purchaseDetails(purchase){
        ...
        $.get('purchases/product_purchase/' + purchase[3], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.Order Tax")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.Order Discount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.Shipping Cost")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.grand total")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.Paid Amount")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td align="right" colspan=7><strong><?php echo e(trans("file.Due")); ?>:</strong></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/salepro/resources/views/purchase/index.blade.php ENDPATH**/ ?>