...
<?php endif; ?>
<?php if($period_invoice_data != null): ?>
<div class="alert-danger hidden p-2 justify-content-center d-flex" id="deadline_warning" role="alert">
  ¡Faltan <?php echo e(Carbon\Carbon::now()->diffInDays($period_invoice_data->deadline)); ?> días para que se venza el período de facturación, comuniquese con el gestor(a)!
</div>
<div class=" alert-warning hidden p-2 justify-content-center d-flex" id="end_warning" role="alert">
  ¡Faltan <?php echo e($period_invoice_data->rank_end - $correlative); ?> facturas para que se termine el rango autorizado para el período de facturación, comuniquese con el gestor(a)!
</div>
<?php endif; ?>
<!-- Side Navbar -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        <?php if($period_invoice_data != null): ?>
                                          <input type="text" name="reference_no" value='<?php echo e($period_invoice_data->emission_point.'-'.$period_invoice_data->agency.'-'.$period_invoice_data->document_type.'-'.$correlative); ?>' class="form-control" placeholder="Type reference number" onkeyup='saveValue(this);' readonly />
                                    ...
                                    <?php if($period_invoice_data != null): ?>
                                     <input type="hidden" name="correlative" value="<?php echo e($correlative); ?>">
                                    <div class="col-md-3">
                                        <input class="form-control" id="start" name="start" type="text" value="<?php echo e($period_invoice_data->rank_start); ?>" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <input class="form-control" id="end" name="end" type="text" value="<?php echo e($period_invoice_data->rank_end); ?>" readonly>
                                    </div>
                                    <div class="col-md-3">
                                        <input class="form-control" id="deadline" name="deadline" type="text" value="<?php echo e(\Carbon\Carbon::parse($period_invoice_data->deadline)->format('Y-m-d')); ?>" readonly>
                                    </div>
                                    <?php endif; ?>
                                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <select name="paid_by_id_select" class="form-control selectpicker">
                                                <option value="1"><?php echo e(trans("file.Cash")); ?></option>
                                                <option value="2"><?php echo e(trans("file.Gift Card")); ?></option>
                                                <option value="3"><?php echo e(trans("file.Card")); ?></option>
                                                <option value="4"><?php echo e(trans("file.Cheque")); ?></option>
                                                <option value="5"><?php echo e(trans("file.Paypal")); ?></option>
                                                <option value="6"><?php echo e(trans("file.Deposit")); ?></option>
                                                <?php if($lims_reward_point_setting_data->is_active): ?>
                                                <option value="7"><?php echo e(trans("file.Points")); ?></option>
                                                <?php endif; ?>
                                            </select>
                                        </div>
                ...
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <div class="row">
                          <div class="col-md-4 form-group warehouse-section">
                            ...
                            <div class="col-md-4 form-group period-section">
                              <label><?php echo e(trans('file.Period')); ?> *</strong> </label>
                              <select required name="period_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Period...">
                                  <?php $__currentLoopData = $lims_period_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($period->id); ?>"><?php echo e($period->description); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/salepro/resources/views/sale/pos.blade.php ENDPATH**/ ?>