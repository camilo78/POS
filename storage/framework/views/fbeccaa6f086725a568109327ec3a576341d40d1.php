...
<div class=" alert-danger hidden p-2 justify-content-center d-flex" id="deadline_warning" role="alert">
  ¡Faltan <?php echo e(Carbon\Carbon::now()->diffInDays($period_invoice_data->deadline)); ?> día para que se venza el período de facturación, comuniquese con el gestor(a)!
</div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.Invoice')); ?>

                                            </label>
                                            <?php if($period_invoice_data != null): ?>
                                            <input type="text" name="reference_no" value='<?php echo e($period_invoice_data->emission_point.'-'.$period_invoice_data->agency.'-'.$period_invoice_data->document_type.'-'.$correlative); ?>' class="form-control" readonly >
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/salepro/resources/views/sale/create.blade.php ENDPATH**/ ?>