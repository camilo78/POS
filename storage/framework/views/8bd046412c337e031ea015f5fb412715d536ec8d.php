                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.RTN')); ?></label>
                                        <input type="text" name="rtn" placeholder="Registro Tributario"  class="form-control" value="<?php echo e($lims_general_setting_data->rtn); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\salepro\resources\views/setting/general_setting.blade.php ENDPATH**/ ?>