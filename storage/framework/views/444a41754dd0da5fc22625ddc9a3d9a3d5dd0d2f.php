            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span><?php echo e(trans('file.settings')); ?></span></a>
                <ul id="setting" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                  <?php if($pos_setting_permission_active): ?>
                  <li id="pos-setting-menu"><a href="<?php echo e(route('period.index')); ?>"> <?php echo e(trans('file.Period')); ?></a></li>
                  <?php endif; ?>
                </ul>
              </li>
            </ul>
...
<?php /**PATH C:\laragon\www\salepro\resources\views/layout/main.blade.php ENDPATH**/ ?>