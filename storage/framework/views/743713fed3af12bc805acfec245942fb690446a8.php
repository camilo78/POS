...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <h1><?php echo e($lims_biller_data->company_name); ?></h1>
        ...
        <table>
            <tbody>
                ...
                <th colspan="2" style="text-align:left"><?php echo e(trans('file.Invoice')); ?> <br> <?php echo e($lims_sale_data->reference_no); ?></th>
                <th style="text-align:right"><?php echo e(trans('file.Date')); ?> <br> <?php echo e($lims_sale_data->created_at->format('d/m/Y')); ?></th>
            </tr>
            </tbody>
        </table>
        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Total')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->total_price, 2, '.', '')); ?></th>
                </tr>
                ...
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Order Tax')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->order_tax, 2, '.', '')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->order_discount): ?>
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Order Discount')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->order_discount, 2, '.', '')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->coupon_discount): ?>
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Coupon Discount')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->coupon_discount, 2, '.', '')); ?></th>
                </tr>
                <?php endif; ?>
                <?php if($lims_sale_data->shipping_cost): ?>
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Shipping Cost')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->shipping_cost, 2, '.', '')); ?></th>
                </tr>
                <?php endif; ?>
                <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.grand total')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$lims_sale_data->grand_total, 2, '.', '')); ?></th>
                </tr>
                <?php if($balance != 0): ?>
                <tr>
                 ...
                 <tr>
                    <th colspan="2" style="text-align:right"><?php echo e(trans('file.Balance')); ?></th>
                    <th style="text-align:right"><?php echo e($currency->code); ?> <?php echo e($balance); ?></th>
                </tr>
                <?php endif; ?>
                <tr>
                    <?php if($general_setting->currency_position == 'prefix'): ?>
                    <th class="centered" colspan="3"><?php echo e(trans('file.In Words')); ?>: <span><?php echo e(str_replace("-"," ",$numberInWords)); ?> con <?php echo e(substr(number_format((float)$lims_sale_data->paid_amount, 2, '.', ''),-2)); ?>/100</span></th>
                    <?php else: ?>
        ...
        <table>
            <tbody>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr><td class="centered small" style="font-style: italic;" colspan="3"><?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?></td></tr>
                ...
                <tr><td class="centered foot" colspan="3">CAI: 000000-000000-000000-000000-00000-00</td></tr>
                <tr><td class="centered foot" colspan="3">RANGO AUTORIZADO: 000-000-00-000000000/000000000</td></tr>
                <tr><td class="centered foot" colspan="3">FECHA LIMITE DE EMISIÓN: DD/MM/AAAA</td></tr>
...
<?php /**PATH C:\laragon\www\salepro\resources\views/sale/invoice.blade.php ENDPATH**/ ?>