                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        @if($period_invoice_data != null)
                                          <input type="text" name="reference_no" value='{{ $period_invoice_data->emission_point.'-'.$period_invoice_data->agency.'-'.$period_invoice_data->document_type.'-'.$correlative }}' class="form-control" placeholder="Type reference number" onkeyup='saveValue(this);' readonly />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <select name="paid_by_id_select" class="form-control selectpicker">
                                                <option value="1">{{ trans("file.Cash") }}</option>
                                                <option value="2">{{ trans("file.Gift Card") }}</option>
                                                <option value="3">{{ trans("file.Card") }}</option>
                                                <option value="4">{{ trans("file.Cheque") }}</option>
                                                <option value="5">{{ trans("file.Paypal") }}</option>
                                                <option value="6">{{ trans("file.Deposit") }}</option>
                                                @if($lims_reward_point_setting_data->is_active)
                                                <option value="7">{{ trans("file.Points") }}</option>
                                                @endif
                                            </select>
                                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-4 form-group warehouse-section">
                            ...
                            <div class="col-md-4 form-group period-section">
                              <label>{{trans('file.Period')}} *</strong> </label>
                              <select required name="period_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Period...">
                                  @foreach($lims_period_list as $period)
