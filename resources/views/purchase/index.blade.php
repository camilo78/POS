...
<script type="text/javascript">
    ...
    function imprSelec(seleccion) {
      ...
      ventimp.document.write('<html><head><title>' + document.title + '</title> </title> <style media="print"> .col-md-12{margin-bottom:0px} @page {size: auto;/* es el valor por defecto */ margin: 0cm; margin-bottom 1px;}.col-md-6 {width:48%; margin-right:5px; margin-bottom:25px;float:left;}body{font-size:14px;margin:0px;transform: scale(.9);} table {cell-spacing: 0;border-collapse: collapse; margin-top 50px !important;page-break-after:auto} tr    { page-break-inside:avoid; page-break-after:auto }td{ page-break-inside:avoid; page-break-after:auto }thead{ display:table-header-group }tfoot { display:table-footer-group }thead > tr {background-color: #025B86;color: white;}thead > tr > * {font-size: 13px;padding: 0.45em;} tr > * {padding: 0.125em 0.45em;} th, td{border: solid 1px #025B86;} .text-right{text-align: right } .text-center{text-align: center; } .d-print-none{display:none} h5{font-size:18px;margin-top: 0;margin-bottom:10px;text-align:center;} h1, h3{text-align:center}</style>');
